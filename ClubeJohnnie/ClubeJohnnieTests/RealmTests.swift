...
//    
//    func setupDatabase() {
//        Realm.Configuration.defaultConfiguration.inMemoryIdentifier = "\(self.name)\(Date())"
//    }
//    
//    func clearDatabase() {
//        let realm = try! Realm()
...
//        let filePath = bundle.path(forResource: "Friends", ofType: "json")
...
//        let name = "John"
//        let age = 26
//        let expectation = self.expectation(description: "save user")
//        
